...
function renderHelp() {
  ...
  const cmds = [
    ...
    ["tt users", "user ranking (today)"],
    ["tt users daily", "user ranking (last 7 days)"],
    ["tt users weekly", "user ranking (last 4 weeks)"],
    ["tt project users", "user ranking (current project)"],
    ["tt help", "show help"],
